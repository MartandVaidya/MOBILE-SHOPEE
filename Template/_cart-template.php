            ...
            <div class="container-fluid w-75">
                ...
                <div class="row">
                        ...
                        <div class="row border-top py-3 mt-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="d-flex">
                                    ...
                                    <a href="#" class="px-2 font-rale font-size-14">23,534 ratings</a>
                                </div>
                                <!-- !product rating -->
                                ...
                                <div class="qty d-flex pt-2">
                                    <div class="d-flex font-rale w-25">
                                        ...
                                        <input type="text" data-id="<?php echo $item['item_id'] ?? '0';?>" class="qty_input border px-2 w-50 bg-light" disabled
                    ...
                    <?php
                        ...
                        },$cart); ///closing arra map function
                          endforeach;
                    ?>
                        </div>
                    <div class="col-sm-3">
                        <div class="sub-total border text-center mt-2">
                            <h6 class="font-size-12 font-rale text-success py-3"><i  class="fas fa-check"></i>You order is eligible for FREE Delivery</h6>
                            <div class="border-top py-4">
                                ...
                                <button class="btn font-baloo btn-warning mt-3">Proceed to Buy</button>
                            </div>
                        </div>
                    </div>
                </div>
