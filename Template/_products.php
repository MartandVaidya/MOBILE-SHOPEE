        ...
        <div class="row">
          ...
          <div class="col-sm-6 py-5">
            ...
            <div class="d-flex">
              ...
              <a href="#" class="px-2 font-rale font-size-14">23,534 ratings | 1000+ answered questions</a>
            </div>
            <hr class="m-0">
            ...
            <table class="my-3">
              ...
              <tr class="font-rale font-size-14">
                <td>You Save:</td>
                <td class="font-size-16 text-danger">$<span>10</span></td>
              </tr>
            </table>
            ...
            <div class="policy">
              <div class="d-flex">
                ...
                <div class="return text-center mr-5">
                  ...
                  <a href="#" class="font-rale.font-size-12">Shopee<br>Deliverd</a>
                </div>
                <div class="return text-center mr-5">
                  <div class="font-size-20 my-2 color-second">
            ...
            <div id="order-details" class="font-rale d-flex flex-column text-dark">
              <small>Delivery by: May 15 - May 18</small>
              <small>sold by <a href="#">Daily Electronics Shopee</a>(4.4 out of 5 | 20,564 ratings)</small>
              <small><i class="fas fa-map-marker-alt color-primary"></i>&nbsp;&nbsp;Deliver of Customer - 431401</small>
            </div>
